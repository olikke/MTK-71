...
Const
  ...
  IID_IDecklinkVideoDesktop: TGUID ='{A45C974C-5D26-462f-B5F1-88AA1EFFFF63}';
...
Type
  ...
  DECKLINK_VIDEODESKTOPMODE=(DECKLINK_VIDEODESKTOPMODE_DESKTOP,
	                           DECKLINK_VIDEODESKTOPMODE_LASTFRAME,
	                           DECKLINK_VIDEODESKTOPMODE_BLACK,
	                           DECKLINK_VIDEODESKTOPMODE_MAX);
  TDL_DesktopMode=DECKLINK_VIDEODESKTOPMODE;

  IDecklinkVideoDesktop=Interface(IUnknown)
    ['{A45C974C-5D26-462f-B5F1-88AA1EFFFF63}']
    Function SetVideoDesktopMode(Mode: DECKLINK_VIDEODESKTOPMODE): HRESULT; StdCall;
    End;
