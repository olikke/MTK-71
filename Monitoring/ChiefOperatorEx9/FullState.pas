...
begin
  ...
  if CalcColor(TM24102.Color)      then  begin fCCTVColor:=_Red; exit; end;
  ...
  if CalcColor(TM2409[3].Color)    then  begin fCCTVColor:=_Red; exit; end;
  if CalcColor(EM72121.Color)      then  begin fCCTVColor:=_Red; exit; end;
  if CalcColor(EM72122.Color)      then  begin fCCTVColor:=_Red; exit; end;
  ...
  for i:=0 to 27 do if EM7210[i].Use then
