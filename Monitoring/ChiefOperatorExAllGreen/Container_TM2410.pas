...
type
  ...
  private
    ...
    fColor    :TColor;
    fMyDA     :integer;
    //можно сделать массив от переполнения. но у меня всего 1 порт неопределенный
    fPing     :TPing;
    fPEvent   :TEvent;
  ...
  public
    ...
    procedure Execute; override;
                    ...
                    //вторые сокеты для каждого сетевого адаптера компов
...
begin
  ...
  for i:=1 to 16 do
    ...
    begin
      ...
      n[c] :=i;
      if c=4 then
        //ну не делала я динамический массив на event и ping  - в данном случае без надобности
        break;
    end;
  if c<>0 then
  begin
