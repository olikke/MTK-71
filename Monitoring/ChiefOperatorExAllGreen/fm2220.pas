...
begin
  if getkeyState(vk_LButton)<0 then close;
end;
...
begin
  ...
  e3.Text :=FloatToStrF(12,ffFixed,6,2);
  SmartEditColor(e3,_Green);
  e4.Text :=FloatToStrF(33.1,ffFixed,6,2);
  SmartEditColor(e4,_Green);
  ...
  e6.Text :=FloatToStrF(32.5,ffFixed,6,2);
  SmartEditColor(e6,_Green);

    e7.Text :='ON';
    SmartEditColor(e7,_Green);
    e8.Text :=IntToStr(4500);
    SmartEditColor(e8,_Green);
...
e12.Text:='AUTO';
  ...
  e15.Text:='OFF';
  e16.Text :=IntToStr(128);
  e17.Text :=IntToStr(100);
  e18.Text :=IntToStr(128);
  e19.Text :=IntToStr(100);
end;
