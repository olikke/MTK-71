...
begin
 ...
 if  KeyDataToShiftState(msg.KeyData) = [ssalt] then

 msg.Result := 1;

  with msg do begin

    // if  CharCode = VK_menu then Result := 1;
    ...
    begin
      Click;
      Result := 1;
    end else if  (FDefault) and (Result=0)  then begin
      Click;
      Result := 1;
    end
    else inherited;
...
begin
  ...
  csNeoSun:      begin
    ...
    olRed:     begin
                   ...
                   DownColorBorder := $0000009D;
                   DownColorDark   := $002040FF;
                   DownColorFace   := $002040FF;
                   DownColorGrad   := $002040FF;
                   DownColorLight  := $002040ff;
                   DownColorText   := $00404040;

                   OverColorBorder := $0000009D;
                   OverColorDark   := $003d57ff;
                   OverColorFace   := $003d57ff;
                   OverColorGrad   := $003d57ff;
                   OverColorLight  := $003d57ff;
                   OverColorText   := clBlack;
                   Gradient:= false;
                 end;
    ...
    olGreen:     begin
                   ...
                   DownColorBorder := $00156F37;
                   DownColorDark   := $0040FF40;
                   DownColorFace   := $0040FF40;
                   DownColorGrad   := $0040FF40;
                   DownColorLight  := $0040FF40;
                   DownColorText   := $00404040;

                   OverColorBorder := $0017793D;
                   OverColorDark   := $0044FF05;
                   OverColorFace   := $0044FF05;
                   OverColorGrad   := $0044FF05;
                   OverColorLight  := $0044FF05;
                   OverColorText   := clBlack;
                   Gradient:= false;
                 end;
     olSilver:     begin
